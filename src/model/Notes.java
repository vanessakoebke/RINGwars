...
import java.util.*;
/**
 * Represents the notes that the agents creates during the round and which he accesses during his round to determine his behavior.
 * <p>
 ...
 *   <li>A list of nodes that the agent attacked in the current round 
 *       (includes direct and border attacks)</li>
 *   <li>The relative number of attacks that were blocked by the opponent 
 *       (blocked attacks / my attacks)</li>
 *   <li>The relative number of attacks defended in the previous round</li>
 *   <li>The buffer of additional fernies used in attacks 
 *       (e.g., a buffer of 1.1 means that if a node has 10 enemy fernies, 
 *       the agent attacks with 11 fernies)</li>
 * </ul>
 */
public class Notes {
    ...
    public Notes(int round, StrategyOpponent strategyOpponent, int totalAttacksByOpponent, int lastRoundAttacksByOpponent, int visibility, 
             double blockedAttacksTotal, double blockedAttacksLastRound, double attackBuffer) {
    ...
    public Notes(int round, int visibility) {
        this(round, StrategyOpponent.UNKNOWN, 0, 0, visibility, 0.0, 0.0, 1.0);
    }
